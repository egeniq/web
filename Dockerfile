...
RUN apt-get -qq update && \
	...
	apt-get update -qq && \
    apt-get install -qq wget nginx nginx-extras php5.6 php5.6-fpm php5.6-cli php5.6-mysql php5.6-curl php5.6-intl php5.6-mbstring php5.6-xml git nodejs npm && \
